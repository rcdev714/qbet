...
**2.1. Personal Data.** Personally identifiable information, such as your name,
email address, and profile image, that you voluntarily give to us when you
register with the App.

**2.2. Derivative Data.** Information our servers automatically collect when you
access the App, such as your IP address, your device type, your operating
system, your access times, and the pages you have viewed directly before and
after accessing the App.

**2.3. Financial Data.** **For "Play Mode" users:** We do NOT collect or store
credit card numbers or banking information, as Play Mode is a free-to-play
simulation. **For Payment Features (if applicable):** Financial data related to
payments is processed and stored by our third-party payment processor (Stripe).
We do not store full credit card numbers on our servers.

**2.4. Mobile Device Access.** We may request access or permission to certain
features from your mobile device, including your mobile device’s camera (for QR
codes/profile photos) and photo library. If you wish to change our access or
permissions, you may do so in your device’s settings.

## 3. USE OF YOUR INFORMATION

Having accurate information about you permits us to provide you with a smooth,
efficient, and customized experience. We may use information collected about you
via the App to:

- Create and manage your account.
- Compile anonymous statistical data and analysis for use internally.
- Facilitate social interactions and leaderboards.
...
- Prevent fraudulent transactions, monitor against theft, and protect against
  criminal activity.
- Send you a welcome email and necessary administrative notifications.

## 4. DISCLOSURE OF YOUR INFORMATION

We do not sell your personal data. We may share information we have collected
about you in certain situations:

**4.1. By Law or to Protect Rights.** If we believe the release of information
...
**4.2. Third-Party Service Providers.** We may share your information with third
parties that perform services for us or on our behalf, including payment
processing (Stripe), data analysis, email delivery, hosting services (Supabase),
...
13, please contact us using the contact information provided below. Given the
nature of prediction markets, we generally restrict the App to users aged
**17+** in accordance with App Store guidelines.
...
- Using the "Delete Account" function in the Settings menu.
