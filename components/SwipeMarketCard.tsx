...
const styles = StyleSheet.create({
  ...
  badgeText: { color: '#fff', fontSize: 10, fontWeight: '400', letterSpacing: 0.5, },
  ...
  winAmount: { fontSize: 18, fontWeight: '400', letterSpacing: 0.5, textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 8, },
  ...
  primaryCtaText: { color: '#fff', fontSize: 13, fontWeight: '400' },
