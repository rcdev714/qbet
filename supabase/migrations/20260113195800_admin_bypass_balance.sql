-- Update place_bet to allow admins to bet without sufficient balance and without deduction
...
begin
  ...
  -- Logic: If admin, skip balance check and deduction. If regular user, enforce it.
