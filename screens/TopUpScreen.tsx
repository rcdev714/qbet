                        ...
                        />
                         ...
                         {amount && !isNaN(parseFloat(amount)) && parseFloat(amount) > 0 && (
                            <View style={[styles.receiptContainer, { backgroundColor: isDark ? '#1C1C1E' : '#F2F2F7', borderColor: theme.border }]}>
                                ...
                                <View style={styles.receiptRow}>
                                <Text style={[styles.receiptLabel, { color: theme.text, fontWeight: '400', fontSize: 15 }]}>Estimated Payout</Text>
                                <Text style={[styles.receiptValue, { color: theme.success, fontWeight: '400', fontSize: 16 }]}>
